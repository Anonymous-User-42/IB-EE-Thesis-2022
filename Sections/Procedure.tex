...
{Using the materials specified in chapter \ref{mat}, arrange the components as specified in figure \ref{exp1}}

{Following which, according to the \textbf{specified initial conditions} specified in the next chapter carefully oscillate the pendulum.}

%\textit{To veiw my setup, please visit \url{https://drive.google.com/drive/folders/1YafHrmBRjN8Lr-JwMOWOKlJYYbO8FsG4?usp=sharing}}
